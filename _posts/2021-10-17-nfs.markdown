...
file server as a [RAID]({% post_url 2021-04-04-raid %}) array, 
...
system is actually composed of a client-side and a server-side file system.
</figcaption> </figure>
...
**NFS’s design goals:** The main goal for NFS designer’s was to have fast and
